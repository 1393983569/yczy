<template>
  <div>
    <Button type="primary" @click="addConfig">添加法律法规</Button>
    ...
    <Modal
      ...
      :mask-closable="false"
      width="900">
       <addLawsAndRegulations @submitState="submitState" :row="row" ref="equipmentManagementRef" />
        <div slot="footer">
...
<script>
  ...
  import { getPageList, deleteLaw } from '@/api/userManagement/lawsAndRegulations'
  import addLawsAndRegulations from './components/addLawsAndRegulations'
